...
Create a new archive, by default with a random name, standard storage (0.0002€/GB/month), automatic locked in 7 days and your datas will be stored in the zone you choose (by default at DC4).
...
Options:
  ...
  -z, --zone=2          Choose the zone (platform)

Examples:
        $ c14 create
        $ c14 create --name "MyBooks" --zone 1
        $ c14 create --name "MyBooks" --description "hardware books" --zone 2
